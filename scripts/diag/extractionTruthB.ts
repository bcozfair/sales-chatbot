...
const DECISIONS: Record<string, Decision> = {
  ...
  'b-4924': { verdict: 'ASK_BACK', review: 'pending', why: 'ไม่มีรายการสินค้าเลย (ต่างจาก b-4742 ที่ขาดแค่จำนวน) และประวัติล่าสุดห่าง 2 วัน — เจ้าของยังไม่ได้เคาะข้อนี้โดยตรง' },
};
