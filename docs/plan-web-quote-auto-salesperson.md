...
· ⚠️ `docs/design.md` §8 ให้ค่าที่คนตั้งทับมี "ปุ่มกลับไปค่าเดิม + บรรทัดบอกค่าเดิม" ด้วย — ช่องนี้เจ้าของเลือก
แบบ A ที่มีแค่ป้าย (ยังไม่มีปุ่ม/บรรทัด) · รอเจ้าของเคาะว่าจะเติมไหม
...
- `scripts/diag/webSalesOwnerUiProbe.ts` — เปิดหน้าจริงแล้วกดจริงที่ 1280/390 (ช่องว่าง → เติม + "ระบบเลือก"
  → บริษัทที่หาไม่ได้ = ว่าง + กล่องเหลือง → "เลือกเอง" → เปลี่ยนบริษัทไม่ถูกทับ · ชื่อไม่ถูกตัด · ป้ายไม่ล้นกรอบ)
