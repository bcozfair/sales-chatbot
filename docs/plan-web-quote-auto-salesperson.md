...
7. หน้าจอ = **แบบ A** (ป้ายบอกที่มาอยู่ในช่อง)
...
ป้ายในช่องตาม `source`: `ตามลูกค้า` (customer) · `ตามผู้ติดต่ออื่น` (contact) · `ตามใบล่าสุด`
(last_order) · `ตามใบเก่า` (older_order · วันที่ของใบใน tooltip) · `ตามใบเดิม` (revise) · `เลือกเอง`
— ถ้อยคำของสามป้ายกลางยังรอเจ้าของยืนยัน (mockup `mockups/web-quote-auto-salesperson.html`)
