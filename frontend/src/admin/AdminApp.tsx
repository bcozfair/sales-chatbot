...
const NAV_GROUPS: { key: string; label: string; icon: typeof LayoutDashboard; items: NavItem[] }[] = [
  {
    ...
    items: [
      // `roles` ของสองเมนูนี้มี `salesperson` ด้วย เพราะค่าเริ่มต้นของเซลส์ในสองช่องนี้เป็น
      ...
      // เซลส์ไม่เห็น (เจ้าของปิดเอง 2026-09-23) เพราะกฎทุกข้อของเขาเป็น deny ⇒ สร้างคำขอ
      // ไม่ได้เลย หน้านี้จึงว่างตลอดถ้าเปิดไว้
