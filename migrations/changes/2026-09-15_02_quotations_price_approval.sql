...
--
--   admin    = ทุกอย่าง (อนุมัติได้ด้วย รวมถึงใบของตัวเอง)
--   approver = ทำได้ทุกอย่างของ subadmin **บวก** อนุมัติราคา · อนุมัติใบที่ตัวเองขอได้
--              และแก้จำนวน/ราคา/ส่วนลดในร่างที่รออนุมัติได้เองก่อนกดอนุมัติ
