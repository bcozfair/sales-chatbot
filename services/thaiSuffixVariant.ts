...
//  ผู้เรียกมีสองจุด: `quoteExtraction` (ขอใบเสนอราคา) และ branch PRODUCT_INFO ใน `lineHandler`
//  (ถามราคา/สต็อก — เพิ่ม 2026-09-25 · ทดลองก่อนแก้: ข้อความจริง 160 ข้อความเปลี่ยน 2 ข้อความ
//  ซึ่งเป็นเคส "ดูดออก" ทั้งคู่ · ชุดจำลอง 24/24 จากเดิม 6/24) · หน้าเว็บไม่มีทางถามข้อมูลสินค้า
//
...
//
//  ⚠️ ขั้นนี้แก้ได้แค่คำไทยท้ายชื่อของรุ่นที่ findProduct ส่งมา ไม่ได้ค้นรุ่นใหม่ — "หาผิดซีรีส์"
//  (เช่น `PMV25.01.024` → `PMV12.00024`) แก้ที่ด่านลำดับของรหัสท้าย findProduct (`applySequenceGuard`)
// ─────────────────────────────────────────────────────────────────────────────
