...
/**
 * ชื่อตั้งต้นของบรรทัดค่าบริการที่ "คนกดเพิ่มเอง" (หน้าเว็บขอใบเสนอราคา) — คนละค่ากับ
 * `defaultItemName` ซึ่งเป็นชื่อของบรรทัดที่ **กฎ** เติมให้ (ค่าขนส่งเมื่อยอดไม่ถึงเกณฑ์)
 * เจ้าของสั่ง 2026-09-25: บรรทัดที่คนเพิ่มเองตั้งต้นเป็นคำกลาง ๆ ไม่ใช่ "ค่าขนส่ง"
 * ส่วนบรรทัดของกฎยังใช้ชื่อจากหน้าตั้งค่าเหมือนเดิม
 */
