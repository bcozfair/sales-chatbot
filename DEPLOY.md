...
ส่วนค่ามาตรฐานตามแคตตาล็อก + ตารางรหัสย่อย **ยังไม่ได้เขียน** (รอคำสั่งเจ้าของ) — รันคำสั่งข้างบนซ้ำ (รายงานจะเหลือแค่ของที่ยังไม่มี) · ถ้า image ที่ deploy อยู่ยังไม่มี
