 ...
 *    ของจริง 5 แถว ทับบนค่าเริ่มต้นชุดก่อนหน้า · ที่มาเต็มอยู่ที่ §14.5)
 *
 *    เซลส์เปิดอยู่ **3 ช่อง**: ออกใบ · แก้ใบ · หน้าประวัติใบเสนอราคา
 ...
 *    `approval` **และเปิด `page.approvals` กลับด้วย** ไม่งั้นเขาส่งคำขอได้แต่ตามผลไม่ได้
 *    (และดู §11 ข้อ 4 เรื่องจำนวนผู้อนุมัติก่อน)
 *
...
export const CAPABILITIES: readonly CapabilityDef[] = [
  ...
  },
  {
    ...
    label: 'อนุมัติราคา',
    modes: SWITCH,
    // เซลส์เป็น deny (เจ้าของปิดเอง 2026-09-23) — สอดคล้องกับที่กฎทั้ง 6 ข้อของเขาเป็น deny
    // ล้วน ⇒ เขาสร้างคำขออนุมัติไม่ได้เลยสักแบบ หน้านี้จึงว่างตลอดถ้าเปิดไว้
    defaults: switchFor('allow', 'allow', 'allow', 'deny'),
