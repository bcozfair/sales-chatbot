...
- **`docs/changes-2026-09-24-meeting.md`** — สรุปการเปลี่ยนแปลงหน้าขอใบเสนอราคาตามความต้องการใหม่หลังประชุม 24/9/2026 (ข้อ 1–8 · รวมแถว "ส่วนลดเดิม" และข้อมูลลูกค้าชุดเดียวเมื่อแยกใบ PM/THT)
