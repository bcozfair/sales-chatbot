...
- **`docs/pricing-code-ts-01.md`** — รูปแบบรหัส TS_-01 / TS_-01-0 จากแคตตาล็อกที่เจ้าของส่งมา (2026-09-24 · **ภาพชนะคอลัมน์ G ของชีต**) · ตัวอักษรหลัง M = ตารางรหัสย่อย ไม่ใช่โค้ด · อ่านไม่ครบ **ห้ามเติมสายตั้งต้นทับ**
