...
- **`docs/changes-2026-09-24-meeting.md`** — สรุปการเปลี่ยนแปลงหน้าขอใบเสนอราคาตามความต้องการใหม่หลังประชุม 24/9/2026 (ข้อ 1–11 · รวมแถว "ส่วนลดเดิม" · ข้อมูลลูกค้าชุดเดียวเมื่อแยกใบ PM/THT · ป้าย "ค่าเดิม" ของเครดิต · ลูกค้าเครดิตไม่มีบิลเกิน 12 เดือน → Cash อัตโนมัติ · ข้อ 11 ลดคำเตือนซ้ำ/modal กระชับ)
