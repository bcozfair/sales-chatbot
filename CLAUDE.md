...
- **`docs/plan-pricing-subcodes.md`** — พิมพ์รหัสสินค้าสั่งทำแล้วได้ราคา + ตารางรหัสย่อยที่แอดมินตั้งราคา/กฎเองได้ (เฟส A ทำแล้วใน `prototypes/pricing/` · เฟส B–D ยังเป็นแบบที่เสนอ)
